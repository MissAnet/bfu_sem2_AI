...
# Визуализация данных
colours = ('seagreen', 'darkgreen')  # Цвета для классов
fig, ax = plt.subplots()
ax.set_facecolor('lightgreen')  # Установка цвета фона на светло-зеленый
...
plt.ylabel("Признак 2")
plt.legend()
plt.gca().set_facecolor('lightgreen')  # Установка цвета фона на светло-зеленый для второго графика
plt.show()
